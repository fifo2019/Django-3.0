...
class PizzaShop(models.Model):
    ...
    url = models.URLField(verbose_name='Интернет-фдрес пиццерии')
...
class Pizza(models.Model):
    pizza_shop = models.ForeignKey(PizzaShop, verbose_name='Пиццерия', on_delete=models.CASCADE)
...
class Order(models.Model):
    pizza = models.ForeignKey(Pizza, verbose_name='Пиццa', on_delete=models.CASCADE)
